...
This privacy policy governs your use of software applications by elnimijo games for mobile devices.  
elnimijo games does not request or collect any personally identifiable data from any of our applications. Our applications do not require any form of user registration or provide any mechanism for providing data however we do use analytical information to understand how our applications are used and collect this anonymised data for use with improving the application and fixing any errors that may occur. At no point is any personally identifiable data collected or any information recorded that would allow us to identify you or your device. 
Additionally as our applications are ad-supported, we abide by the policies put in place by Google's ad networks, namely Admob and although our application may not collect any information as detailed above, the advertising provider may do so.
...
Contact us
If you have any questions regarding privacy while using the Application, or have questions about our practices, please contact us via email at games@elnimijo.com.
